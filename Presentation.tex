...
\label{sec:org2f0d2ea}

\begin{frame}[label={sec:org7ff8389}]{Objectives}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org3cf3ddc}]{Structure of the sessions}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org488f75e},fragile]{Repository structure}
...
\end{frame}
\section{Session 1}
\label{sec:org495b2f6}

\begin{frame}[label={sec:org5998fa6},fragile]{C++ for LSD I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf2c6ed4},fragile]{C++ for LSD II}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org92576fe},fragile]{Macro example III}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org9730f49},fragile]{Equation file}
...
\end{frame}
\begin{frame}[label={sec:orgc4cf5da},fragile]{Model structure and data organization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8406dd5},fragile]{Linear model I}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org7bae191},fragile]{Linear model II}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org803a9e8},fragile]{Linear model III}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2534e65}]{Linear model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Linear_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7ee8e91},fragile]{Linear model V}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org3743d9c},fragile]{Linear model VI}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge4fd50e}]{Linear model VII}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgbbef8d6},fragile]{Linear model VIII}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2cb69c7}]{Linear model IX}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Multi_RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org230a76f},fragile]{Logistic chaotic model 0}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org104f2c7}]{Logistic chaotic model I}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org83a2336},fragile]{Logistic chaotic model II}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:orgdbaa584},fragile]{Logistic chaotic model III}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org05d56c5}]{Logistic chaotic model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/chaos_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org538ed43}]{Logistic chaotic model V}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga81117e},fragile]{Logistic chaotic model VI}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org687a470}]{Logistic chaotic model VII}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgca24fa3}]{Logistic chaotic model VIII}
\begin{center}
\includesvg[width=.83\linewidth]{figs/chaotic_bifurcation}
\end{center}
\end{frame}
\section{Session 2}
\label{sec:org66c2633}

\begin{frame}[label={sec:orgc74b714}]{Simulation pipeline}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0211152}]{The Industry model}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org71dba71}]{Equations}
\[ \begin{array}{lrl}
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:org159ef83}]{DAG of industry model}
\resizebox{\linewidth}{!}{%
  \begin{tikzpicture}[
...
\end{frame}
\begin{frame}[label={sec:orgad09580},fragile]{Sequence of events}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgdbb4c01}]{Parameters and initial values}
\begin{table}[htbp]
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org7b2611b}]{Model structure and data organization II}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgb39095e}]{Memo: Equations}
\[ \begin{array}{lrl}
\mbox{Idiosyncratic learning process:} & a_{i,t} = &a_{i,t-1}\cdot (1 + \theta_{i,t})\\
\mbox{Learning shocks} & \theta_{i,t} \sim  & Beta(\beta_1, \beta_2)\\
\mbox{Market selection} & s_{i,t} =  & s_{i,t-1} \cdot \left( 1 + A\cdot\frac{a_{i,t} - \bar{a}_{t}}{\bar{a}_{t}}\right) \\
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:org5014a62},fragile]{Firm-level productivity (\(a_{i}\)\textsubscript{nil})}
 \begin{equation}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org6600218},fragile]{Market-share (\(s_{i}\))}
 \begin{equation}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:orgbe3ff4b},fragile]{Entry-Exit condition}
 \begin{Code}
\begin{Verbatim}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:orgd3b3d37},fragile]{Herfindahl-Hirschman concentration index (\(HHI\))}
 \begin{equation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5f66c0a},fragile]{Initialization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcbdd269},fragile]{Initialization II}
 \begin{Code}
\begin{Verbatim}
...
\end{frame}
\section{Session 3}
\label{sec:orgebc3846}

\begin{frame}[label={sec:orge16a112}]{Where are we are where are we going?}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org9e00981}]{Analyzing the model results}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge2fd7b7}]{Exploring the single run results}
\begin{figure}[ht]
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org8c6c08f},fragile]{Activity I}
 \begin{enumerate}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org6d53f1e}]{Histogram of firm log-size distribution (\(t = 200\))}
\begin{center}
\includesvg[width=.9\linewidth]{./figs/150_firms_log_size_histogram}
\end{center}
\end{frame}
\begin{frame}[label={sec:org0ee5667}]{A simple Monte Carlo experiment I}
\begin{enumerate}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org99daec9}]{A simple Monte Carlo experiment II}
\begin{center}
\includesvg[width=.9\linewidth]{./figs/HHI_MC}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4f56e1b}]{Activity II}
\begin{enumerate}
...
\end{frame}
\section{Bonus}
\label{sec:orgc15c1df}

\begin{frame}[label={sec:orge7fce65}]{Model sensitivity to parameters}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org480372f}]{Sensitivity analysis}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgecd3974}]{Parametric space}
\begin{center}
\begin{tabular}{ccccc}
\hline
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgabcced0}]{Exploring the industry model}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7b62d64}]{Phew!}
