...
\end{frame}
\section{Session 1}
\label{sec:orgb27e951}

\begin{frame}[label={sec:org2f0324d},fragile]{C++ for LSD I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6647029},fragile]{C++ for LSD II}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgdaee077},fragile]{Macros I}
 \begin{figure}[htbp]
\centering
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgf8ffe3e}]{Macros II}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org4571f6a},fragile]{Macro example I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6f4d166},fragile]{Linear model I}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org311cfaa},fragile]{Linear model II}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org9f60889},fragile]{Linear model III}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2ec9e6d}]{Linear model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Linear_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgaa54c0e},fragile]{Linear model V}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgcd5dde3},fragile]{Linear model VI}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org83b097c}]{Linear model VII}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:orge69c413},fragile]{Linear model VIII}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org90ea0ed}]{Logistic chaotic model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/chaos_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org62a776a}]{Logistic chaotic model V}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6c15754},fragile]{Logistic chaotic model VI}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org089832d}]{Logistic chaotic model VII}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga2d439f}]{Logistic chaotic model VIII}
\begin{center}
\includesvg[width=.83\linewidth]{figs/chaotic_bifurcation}
\end{center}
\end{frame}
\section{Session 2}
\label{sec:org4a8de06}

\begin{frame}[label={sec:org2f30536}]{Simulation pipeline}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org05e5bc8}]{The Industry model}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org668d630}]{Equations}
\[ \begin{array}{lrl}
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:org7c47496}]{DAG of industry model}
\resizebox{\linewidth}{!}{%
  \begin{tikzpicture}[
...
\end{frame}
\begin{frame}[label={sec:orgfdceb9a},fragile]{Sequence of events}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb194678}]{Parameters and initial values}
\begin{table}[htbp]
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgb17c9e6}]{Model structure and data organization II}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org3b1192c}]{Memo: Equations}
\[ \begin{array}{lrl}
\mbox{Idiosyncratic learning process:} & a_{i,t} = &a_{i,t-1}\cdot (1 + \theta_{i,t})\\
\mbox{Learning shocks} & \theta_{i,t} \sim  & Beta(\beta_1, \beta_2)\\
\mbox{Market selection} & s_{i,t} =  & s_{i,t-1} \cdot \left( 1 + A\cdot\frac{a_{i,t} - \bar{a}_{t}}{\bar{a}_{t}}\right) \\
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:org689ff21},fragile]{Firm-level productivity (\(a_{i}\)\textsubscript{nil})}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org450e03d},fragile]{Market-share (\(s_{i}\))}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgf4ae5ec},fragile]{Exit condition}
 \begin{verbatim}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgdd7b71c},fragile]{Market-level Productivity (Weighted) Average (\(\bar{a_{t}}\))}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgb406fc5},fragile]{Entry-Exit condition}
 \begin{verbatim}
EQUATION( "exit_entry" )
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org24c5ca8},fragile]{Herfindahl-Hirschman concentration index (\(HHI\))}
 \begin{equation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc5e2eee},fragile]{Initialization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb29e2bf},fragile]{Initialization II}
 \begin{verbatim}
EQUATION( "init" )
