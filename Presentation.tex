...
\label{sec:orgab91e8d}

\begin{frame}[label={sec:org4e90649}]{Objectives}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org0ddea42}]{Structure of the sessions}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgf64accd},fragile]{Repository structure}
...
\end{frame}
\section{Session 1}
\label{sec:orgfe00c57}

\begin{frame}[label={sec:orgdde9941},fragile]{C++ for LSD I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8283898},fragile]{C++ for LSD II}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org3830c26},fragile]{Macros I}
 \begin{figure}[htbp]
\centering
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org52b9b62}]{Macros II}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org2d96c4a},fragile]{Macro example I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8ac1899},fragile]{Macro example II}
 How can we write the following equation using LSD syntax?
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orge19f8c8},fragile]{Macro example III}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org7d79342},fragile]{Equation file}
...
\end{frame}
\begin{frame}[label={sec:org68270f6},fragile]{Model structure and data organization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org40e0a3e},fragile]{Linear model I}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org7a0c8bc},fragile]{Linear model II}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgd0f9745},fragile]{Linear model III}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org103407e}]{Linear model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Linear_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org73e381d},fragile]{Linear model V}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org4ee074d},fragile]{Linear model VI}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org89b7f61}]{Linear model VII}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1a76611},fragile]{Linear model VIII}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf2e5f75}]{Linear model IX}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Multi_RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org6d19cd7},fragile]{Logistic chaotic model 0}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgd8baffa}]{Logistic chaotic model I}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org50ace02},fragile]{Logistic chaotic model II}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org61ef943},fragile]{Logistic chaotic model III}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org25db41c}]{Logistic chaotic model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/chaos_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfaa307b}]{Logistic chaotic model V}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org12c9dcd},fragile]{Logistic chaotic model VI}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6cbf3cf}]{Logistic chaotic model VII}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org02e7a05}]{Logistic chaotic model VIII}
\begin{center}
\includesvg[width=.83\linewidth]{figs/chaotic_bifurcation}
\end{center}
\end{frame}
\section{Session 2}
\label{sec:org09d419c}

\begin{frame}[label={sec:org9413cad}]{Simulation pipeline}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6ffb257}]{The Industry model}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0c9f98f}]{Equations}
\[ \begin{array}{lrl}
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:org639055c}]{DAG of industry model}
\resizebox{\linewidth}{!}{%
  \begin{tikzpicture}[
...
\end{frame}
\begin{frame}[label={sec:org853b8e8},fragile]{Sequence of events}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd81c8ae}]{Parameters and initial values}
\begin{table}[htbp]
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgf85dcb0}]{Model structure and data organization II}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org9d93959}]{Memo: Equations}
\[ \begin{array}{lrl}
\mbox{Idiosyncratic learning process:} & a_{i,t} = &a_{i,t-1}\cdot (1 + \theta_{i,t})\\
\mbox{Learning shocks} & \theta_{i,t} \sim  & Beta(\beta_1, \beta_2)\\
\mbox{Market selection} & s_{i,t} =  & s_{i,t-1} \cdot \left( 1 + A\cdot\frac{a_{i,t} - \bar{a}_{t}}{\bar{a}_{t}}\right) \\
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:org501af80},fragile]{Firm-level productivity (\(a_{i}\)\textsubscript{nil})}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org7d97491},fragile]{Market-share (\(s_{i}\))}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org00d5d3d},fragile]{Exit condition}
 \begin{verbatim}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgf97e6d1},fragile]{Market-level Productivity (Weighted) Average (\(\bar{a_{t}}\))}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orge3e4823},fragile]{Entry-Exit condition}
 \begin{verbatim}
EQUATION( "exit_entry" )
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org6ddcb36},fragile]{Herfindahl-Hirschman concentration index (\(HHI\))}
 \begin{equation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9eaf743},fragile]{Initialization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6e9bbe4},fragile]{Initialization II}
 \begin{verbatim}
EQUATION( "init" )
...
\end{frame}
\section{Session 3}
\label{sec:orgd42fb21}

\begin{frame}[label={sec:orgbd35df0}]{Where are we are where are we going?}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgd2aac43}]{Analyzing the model results}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org1f0d839}]{Exploring the single run results}
\begin{figure}[ht]
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org97432c8},fragile]{Activity I}
 \begin{enumerate}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orgcc6c337}]{Histogram of firm log-size distribution (\(t = 200\))}
\begin{center}
\includesvg[width=.9\linewidth]{./figs/150_firms_log_size_histogram}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgcee3747}]{A simple Monte Carlo experiment I}
\begin{enumerate}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org83f609f}]{A simple Monte Carlo experiment II}
\begin{center}
\includesvg[width=.9\linewidth]{./figs/HHI_MC}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5efb443}]{Activity II}
\begin{enumerate}
...
\end{frame}
\section{Bonus}
\label{sec:orgf08e542}

\begin{frame}[label={sec:org791d27a}]{Model sensitivity to parameters}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc11f40a}]{Sensitivity analysis}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org92c9846}]{Parametric space}
\begin{center}
\begin{tabular}{ccccc}
\hline
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8c8f288}]{Exploring the industry model}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orga4d5631}]{Phew!}
