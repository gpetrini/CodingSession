...
\label{sec:org3a1dd6a}

\begin{frame}[label={sec:org2588cb9}]{Objectives}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org316fc75}]{Structure of the sessions}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org25a74b2},fragile]{Repository structure}
...
\end{frame}
\section{Session 1}
\label{sec:orgf056a27}

\begin{frame}[label={sec:org2b10184},fragile]{C++ for LSD I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6e34d15},fragile]{C++ for LSD II}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org66ed96e},fragile]{Macro example III}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org7e6ea50},fragile]{Equation file}
...
\end{frame}
\begin{frame}[label={sec:org8eae8a4},fragile]{Model structure and data organization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org345ec05},fragile]{Linear model I}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org8e7f12a},fragile]{Linear model II}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org8c94d64},fragile]{Linear model III}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org816e792}]{Linear model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Linear_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org42487d7},fragile]{Linear model V}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:orgec9cbdf},fragile]{Linear model VI}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org00b9dc6}]{Linear model VII}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org15046e5},fragile]{Linear model VIII}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgac300d4}]{Linear model IX}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Multi_RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5153cff},fragile]{Logistic chaotic model 0}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:org393f2da}]{Logistic chaotic model I}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orge6f374b},fragile]{Logistic chaotic model II}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:orgee26078},fragile]{Logistic chaotic model III}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org63d2431}]{Logistic chaotic model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/chaos_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org3dd9a5a}]{Logistic chaotic model V}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7c6c6c9},fragile]{Logistic chaotic model VI}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4e9561e}]{Logistic chaotic model VII}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb912f07}]{Logistic chaotic model VIII}
\begin{center}
\includesvg[width=.83\linewidth]{figs/chaotic_bifurcation}
\end{center}
\end{frame}
\section{Session 2}
\label{sec:orge497e30}

\begin{frame}[label={sec:org51b230f}]{Simulation pipeline}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb65e1f4}]{The Industry model}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org9f6acc0}]{Equations}
\[ \begin{array}{lrl}
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:orga9abc17}]{DAG of industry model}
\resizebox{\linewidth}{!}{%
  \begin{tikzpicture}[
...
\end{frame}
\begin{frame}[label={sec:org8074d61},fragile]{Sequence of events}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd87a818}]{Parameters and initial values}
\begin{table}[htbp]
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org6d08c48}]{Model structure and data organization II}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org151e507}]{Memo: Equations}
\[ \begin{array}{lrl}
\mbox{Idiosyncratic learning process:} & a_{i,t} = &a_{i,t-1}\cdot (1 + \theta_{i,t})\\
\mbox{Learning shocks} & \theta_{i,t} \sim  & Beta(\beta_1, \beta_2)\\
\mbox{Market selection} & s_{i,t} =  & s_{i,t-1} \cdot \left( 1 + A\cdot\frac{a_{i,t} - \bar{a}_{t}}{\bar{a}_{t}}\right) \\
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:org08b1b13},fragile]{Firm-level productivity (\(a_{i}\)\textsubscript{nil})}
 \begin{equation}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:orgd0486af},fragile]{Market-share (\(s_{i}\))}
 \begin{equation}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:orgdf85cb5},fragile]{Entry-Exit condition}
 \begin{Code}
\begin{Verbatim}
...
\end{Code}
\end{frame}
\begin{frame}[label={sec:orga49291c},fragile]{Herfindahl-Hirschman concentration index (\(HHI\))}
 \begin{equation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4a4a35a},fragile]{Initialization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcb1d840},fragile]{Initialization II}
 \begin{Code}
\begin{Verbatim}
...
\end{frame}
\section{Session 3}
\label{sec:orgdcab02e}

\begin{frame}[label={sec:org350cc89}]{Where are we are where are we going?}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org05ef183}]{Analyzing the model results}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgdca773b}]{Exploring the single run results}
\begin{figure}[ht]
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org20067bb},fragile]{Activity I}
 \begin{enumerate}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org88cb04d}]{Histogram of firm log-size distribution (\(t = 200\))}
\begin{center}
\includesvg[width=.9\linewidth]{./figs/150_firms_log_size_histogram}
\end{center}
\end{frame}
\begin{frame}[label={sec:org8cd2caa}]{A simple Monte Carlo experiment I}
\begin{enumerate}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org332a242}]{A simple Monte Carlo experiment II}
\begin{center}
\includesvg[width=.9\linewidth]{./figs/HHI_MC}
\end{center}
\end{frame}
\begin{frame}[label={sec:org158d72c}]{Activity II}
\begin{enumerate}
...
\end{frame}
\section{Bonus}
\label{sec:orgd97a83b}

\begin{frame}[label={sec:org471fcfa}]{Model sensitivity to parameters}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6418b42}]{Sensitivity analysis}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org082409e}]{Parametric space}
\begin{center}
\begin{tabular}{ccccc}
\hline
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org48fd207}]{Exploring the industry model}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8e8a32e}]{Phew!}
