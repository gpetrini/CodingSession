...
\label{sec:org471b907}

\begin{frame}[label={sec:orgb0caee0}]{Objectives}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:org2a74590}]{Structure of the sessions}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org374de56},fragile]{Repository structure}
...
\end{frame}
\section{Session 1}
\label{sec:org4ebc62e}

\begin{frame}[label={sec:org3b477a1},fragile]{C++ for LSD I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org5179518},fragile]{C++ for LSD II}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org340934a},fragile]{Macros I}
 \begin{figure}[htbp]
\centering
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgb598100}]{Macros II}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org157b415},fragile]{Macro example I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgcab8c22},fragile]{Macro example II}
 How can we write the following equation using LSD syntax?
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orge62625c},fragile]{Equation file}
...
\end{frame}
\begin{frame}[label={sec:org1b9f325},fragile]{Model structure and data organization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0b9c37f},fragile]{Linear model I}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgbfe076f},fragile]{Linear model II}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgbe1f67c},fragile]{Linear model III}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org13ca237}]{Linear model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Linear_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5e73cc7},fragile]{Linear model V}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org61e766a},fragile]{Linear model VI}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc8b50f5}]{Linear model VII}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:orge85e9df},fragile]{Linear model VIII}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc388213}]{Linear model IX}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Multi_RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgab9ff5d},fragile]{Logistic chaotic model 0}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org1f9da32}]{Logistic chaotic model I}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orga9bbf9c},fragile]{Logistic chaotic model II}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org0d536a7},fragile]{Logistic chaotic model III}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7e9e8ba}]{Logistic chaotic model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/chaos_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org489383f}]{Logistic chaotic model V}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org6ef69e4},fragile]{Logistic chaotic model VI}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org66aca9c}]{Logistic chaotic model VII}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org08837ed}]{Logistic chaotic model VIII}
\begin{center}
\includesvg[width=.83\linewidth]{figs/chaotic_bifurcation}
\end{center}
\end{frame}
\section{Session 2}
\label{sec:org90365af}

\begin{frame}[label={sec:org9dd420d}]{Simulation pipeline}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2a4746f}]{The Industry model}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd65d403}]{Equations}
\[ \begin{array}{lrl}
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:orgabeadb1}]{DAG of industry model}
\resizebox{\linewidth}{!}{%
  \begin{tikzpicture}[
...
\end{frame}
\begin{frame}[label={sec:orgc2df65d},fragile]{Sequence of events}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgaae137e}]{Parameters and initial values}
\begin{table}[htbp]
...
\end{table}
\end{frame}
\begin{frame}[label={sec:org437047a}]{Model structure and data organization II}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orga3b622c}]{Memo: Equations}
\[ \begin{array}{lrl}
\mbox{Idiosyncratic learning process:} & a_{i,t} = &a_{i,t-1}\cdot (1 + \theta_{i,t})\\
\mbox{Learning shocks} & \theta_{i,t} \sim  & Beta(\beta_1, \beta_2)\\
\mbox{Market selection} & s_{i,t} =  & s_{i,t-1} \cdot \left( 1 + A\cdot\frac{a_{i,t} - \bar{a}_{t}}{\bar{a}_{t}}\right) \\
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:org1ee8174},fragile]{Firm-level productivity (\(a_{i}\)\textsubscript{nil})}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgc092b69},fragile]{Market-share (\(s_{i}\))}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org8d8b8a8},fragile]{Exit condition}
 \begin{verbatim}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org04399f6},fragile]{Market-level Productivity (Weighted) Average (\(\bar{a_{t}}\))}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org48ad696},fragile]{Entry-Exit condition}
 \begin{verbatim}
EQUATION( "exit_entry" )
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgf1f3d52},fragile]{Herfindahl-Hirschman concentration index (\(HHI\))}
 \begin{equation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb86ce9a},fragile]{Initialization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org6280194},fragile]{Initialization II}
 \begin{verbatim}
EQUATION( "init" )
...
\end{frame}
\section{Session 3}
\label{sec:org136b8bf}

\begin{frame}[label={sec:org6fe4d7e}]{Where we are and to where we go?}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:orgfc7ad79}]{Analyze the model results}
\end{frame}

\begin{frame}[label={sec:org679ba43}]{Exploring the single run results}
\end{frame}

\begin{frame}[label={sec:org972c234}]{Activity I}
\end{frame}

\begin{frame}[label={sec:orgbad9db4}]{A simple Monte Carlo experiment}
\end{frame}

\begin{frame}[label={sec:org4f4e607}]{Activity II}
\end{frame}
\end{document}
