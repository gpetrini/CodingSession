...
\label{sec:orgf154752}

\begin{frame}[label={sec:org06b5ac6}]{Objectives}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orgfc9d8cd}]{Structure of the sessions}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org4a0b7e3},fragile]{Repository structure}
...
\end{frame}
\section{Session 1}
\label{sec:org254e9e6}

\begin{frame}[label={sec:org02bc575},fragile]{C++ for LSD I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0aae2f3},fragile]{C++ for LSD II}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgff2e929},fragile]{Macros I}
 \begin{figure}[htbp]
\centering
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org1e96188}]{Macros II}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:orgd63c1a5},fragile]{Macro example I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc966413},fragile]{Macro example II}
 How can we write the following equation using LSD syntax?
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org184628f},fragile]{Equation file}
...
\end{frame}
\begin{frame}[label={sec:org4c8505b},fragile]{Model structure and data organization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc762ba0},fragile]{Linear model I}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org4898ffe},fragile]{Linear model II}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org5065df7},fragile]{Linear model III}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0a653b0}]{Linear model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Linear_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4156bd5},fragile]{Linear model V}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org406e5bb},fragile]{Linear model VI}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge0d54a4}]{Linear model VII}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org53642d2},fragile]{Linear model VIII}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org3c8f736}]{Linear model IX}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/Multi_RW_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7ce7139},fragile]{Logistic chaotic model 0}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgde047a7}]{Logistic chaotic model I}
...
\end{enumerate}
\end{frame}
\begin{frame}[label={sec:orgddf58eb},fragile]{Logistic chaotic model II}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org6eb61c4},fragile]{Logistic chaotic model III}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgdf8cde3}]{Logistic chaotic model IV}
\begin{center}
\includesvg[width=.83\linewidth]{./figs/chaos_X}
\end{center}
\end{frame}
\begin{frame}[label={sec:orge959f9d}]{Logistic chaotic model V}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd654b2f},fragile]{Logistic chaotic model VI}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3b95322}]{Logistic chaotic model VII}
\begin{itemize}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org32b88da}]{Logistic chaotic model VIII}
\begin{center}
\includesvg[width=.83\linewidth]{figs/chaotic_bifurcation}
\end{center}
\end{frame}
\section{Session 2}
\label{sec:orge13e013}

\begin{frame}[label={sec:orgac56ca7}]{Simulation pipeline}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf28a8cb}]{The Industry model}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org19d5eb9}]{Equations}
\[ \begin{array}{lrl}
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:org801cef8}]{DAG of industry model}
\resizebox{\linewidth}{!}{%
  \begin{tikzpicture}[
...
\end{frame}
\begin{frame}[label={sec:org6962cce},fragile]{Sequence of events}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1c21ee4}]{Parameters and initial values}
\begin{table}[htbp]
...
\end{table}
\end{frame}
\begin{frame}[label={sec:orgd71a035}]{Model structure and data organization II}
\begin{figure}[htbp]
\centering
...
\end{figure}
\end{frame}
\begin{frame}[label={sec:org19f84b9}]{Memo: Equations}
\[ \begin{array}{lrl}
\mbox{Idiosyncratic learning process:} & a_{i,t} = &a_{i,t-1}\cdot (1 + \theta_{i,t})\\
\mbox{Learning shocks} & \theta_{i,t} \sim  & Beta(\beta_1, \beta_2)\\
\mbox{Market selection} & s_{i,t} =  & s_{i,t-1} \cdot \left( 1 + A\cdot\frac{a_{i,t} - \bar{a}_{t}}{\bar{a}_{t}}\right) \\
...
\end{array}\]
\end{frame}
\begin{frame}[label={sec:orgd62ae82},fragile]{Firm-level productivity (\(a_{i}\)\textsubscript{nil})}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgf250f4f},fragile]{Market-share (\(s_{i}\))}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org7e8f296},fragile]{Exit condition}
 \begin{verbatim}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org15dd1fa},fragile]{Market-level Productivity (Weighted) Average (\(\bar{a_{t}}\))}
 \begin{equation}
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orgce23354},fragile]{Entry-Exit condition}
 \begin{verbatim}
EQUATION( "exit_entry" )
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:org8ca5686},fragile]{Herfindahl-Hirschman concentration index (\(HHI\))}
 \begin{equation}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge0669e9},fragile]{Initialization I}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd53ff66},fragile]{Initialization II}
 \begin{verbatim}
EQUATION( "init" )
...
\end{frame}
\section{Session 3}
\label{sec:org1171afa}

\begin{frame}[label={sec:orgeadb3b8}]{Where we are and to where we go?}
\begin{description}
...
\end{description}
\end{frame}
\begin{frame}[label={sec:org5ed352f}]{Analyze the model results}
\end{frame}

\begin{frame}[label={sec:org7f23b7b}]{Exploring the single run results}
\end{frame}

\begin{frame}[label={sec:org86fafd4}]{Activity I}
\end{frame}

\begin{frame}[label={sec:orgfe8eac7}]{A simple Monte Carlo experiment}
\end{frame}

\begin{frame}[label={sec:org5041fb4}]{Activity II}
\end{frame}
\end{document}
